    ...
    public void mailTask(){
        ...
        list.forEach(mailLog -> {
            if (3>=mailLog.getCount()){
               ...
               Employee employee = employeeService.getAllEmps(mailLog.getEid()).get(0);
//               重新发送消息
                rabbitTemplate.convertAndSend(MailConstants.MAIL_EXCHANGE_NAME,MailConstants.MAIL_ROUTING_NAME,employee,new CorrelationData(mailLog.getMsgId()));
            }
        });
    }
