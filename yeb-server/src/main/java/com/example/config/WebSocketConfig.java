...
import org.springframework.messaging.simp.stomp.StompHeaderAccessor;import org.springframework.beans.factory.annotation.Value;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    /**
     * 添加这个Endpoint端点，这样在网页可以通过websocket连接上服务
     ...
     */
    /*
    因为我们使用了SpringSecurity，我们需要通过输入管道将token传进来做相应的校验，否则无法进行websocket
    而且security配置也需要放心webSocket
     */
    @Override
